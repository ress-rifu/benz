...
const translations = {
  bn: {
    ...
    settings: {
      ...
      watermarkTitle: "ওয়াটারমার্ক সেটিংস",
      watermarkDesc: "নিচের ডানদিকের ছোট ওয়াটারমার্কটি কাস্টমাইজ করুন",
      watermarkText: "ওয়াটারমার্ক টেক্সট",
      watermarkSize: "ফন্টের আকার (px)",
      watermarkColor: "রঙ",
  ...
  en: {
    ...
    settings: {
      ...
      watermarkDesc: "Customize the tiny printed watermark in the bottom-right corner",
